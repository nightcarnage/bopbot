...
from twitchAPI.type import AuthScope, InvalidRefreshTokenException, UnauthorizedException, TwitchAPIException
...
class UserAuthenticator:
    ...
    def __init__(self,
                 ...
                 url: str = 'http://localhost:5000/twitch_redirect',
                 auth_base_url: str = TWITCH_AUTH_BASE_URL):
        """
    ...
    async def authenticate1(self,
        ...
        if user_token is None:
            ...
            #f = open('./templates/twitch_url.txt', 'w')
            #f.write(self._build_auth_url())
            #f.close()
            #print('Auth URL:', self._build_auth_url())
    ...
    def authenticate2(self, ttoken):
        ...
        #with http.ClientSession(timeout=self._twitch.session_timeout) as session:
